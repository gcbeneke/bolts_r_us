...
"""autogenerated by genpy from weiss_gripper_ieg76/MoveRequest.msg. Do not edit."""
import sys
...
class MoveRequest(genpy.Message):
  ...
  _type = "weiss_gripper_ieg76/MoveRequest"
...
def _get_struct_f():
    ...
    return _struct_f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from weiss_gripper_ieg76/MoveResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class MoveResponse(genpy.Message):
  ...
  _type = "weiss_gripper_ieg76/MoveResponse"
  _has_header = False #flag to mark the presence of a Header object
...
def _get_struct_B():
    ...
    return _struct_B
class Move(object):
  _type          = 'weiss_gripper_ieg76/Move'
  _md5sum = '68db0cb3ba325cf1de1b79dde3e8e0ea'
