...
"""autogenerated by genpy from opt/Bru_irb_correctPositionActionFeedback.msg. Do not edit."""
import sys
...
class Bru_irb_correctPositionActionFeedback(genpy.Message):
  _md5sum = "7d180ca849d0f3ec156099fd160a1ec1"
  _type = "opt/Bru_irb_correctPositionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','opt/Bru_irb_correctPositionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Bru_irb_correctPositionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = opt.msg.Bru_irb_correctPositionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = opt.msg.Bru_irb_correctPositionFeedback()
