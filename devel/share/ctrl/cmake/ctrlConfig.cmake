...
if("TRUE" STREQUAL "TRUE")
  set(ctrl_SOURCE_PREFIX /home/gijs/bolts_ws/src/ctrl)
  set(ctrl_DEVEL_PREFIX /home/gijs/bolts_ws/devel)
  set(ctrl_INSTALL_PREFIX "")
  set(ctrl_PREFIX ${ctrl_DEVEL_PREFIX})
else()
  set(ctrl_SOURCE_PREFIX "")
  set(ctrl_DEVEL_PREFIX "")
  set(ctrl_INSTALL_PREFIX /home/gijs/bolts_ws/install)
...
if(NOT "/home/gijs/bolts_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ctrl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gijs/bolts_ws/src/ctrl/${idir}'.  ${_report}")
    endif()
