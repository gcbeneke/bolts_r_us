...
(cl:defmethod cl:initialize-instance :after ((m <State>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'State)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ctrl-msg:<State> is deprecated: use ctrl-msg:State instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ctrl-msg:state-val is deprecated.  Use ctrl-msg:state instead.")
  (state m))
