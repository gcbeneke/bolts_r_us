...
class Bru_irb_rotateBoltFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Bru_irb_rotateBoltFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Bru_irb_rotateBoltFeedback(null);
...
module.exports = Bru_irb_rotateBoltFeedback;
