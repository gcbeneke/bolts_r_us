...
let Bru_irb_rotateBoltGoal = require('./Bru_irb_rotateBoltGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class Bru_irb_rotateBoltActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new Bru_irb_rotateBoltGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Bru_irb_rotateBoltGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Bru_irb_rotateBoltActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = Bru_irb_rotateBoltGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Bru_irb_rotateBoltActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = Bru_irb_rotateBoltGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new Bru_irb_rotateBoltGoal()
    }
...
module.exports = Bru_irb_rotateBoltActionGoal;
