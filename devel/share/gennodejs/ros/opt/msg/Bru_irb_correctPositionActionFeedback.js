...
let Bru_irb_correctPositionFeedback = require('./Bru_irb_correctPositionFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class Bru_irb_correctPositionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new Bru_irb_correctPositionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Bru_irb_correctPositionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Bru_irb_correctPositionActionFeedback(null);
    ...
    data.feedback = Bru_irb_correctPositionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Bru_irb_correctPositionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = Bru_irb_correctPositionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new Bru_irb_correctPositionFeedback()
    }
...
module.exports = Bru_irb_correctPositionActionFeedback;
