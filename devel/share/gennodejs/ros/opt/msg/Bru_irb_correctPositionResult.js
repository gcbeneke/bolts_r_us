...
class Bru_irb_correctPositionResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Bru_irb_correctPositionResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Bru_irb_correctPositionResult(null);
...
module.exports = Bru_irb_correctPositionResult;
