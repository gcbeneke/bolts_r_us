...
class Bru_irb_rotateBoltResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Bru_irb_rotateBoltResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Bru_irb_rotateBoltResult(null);
...
module.exports = Bru_irb_rotateBoltResult;
