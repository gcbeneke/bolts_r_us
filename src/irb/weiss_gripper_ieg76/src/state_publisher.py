...
class StatesPublisher(threading.Thread):
	def __init__(self, loop_time, serial_port_comm):
		...
		self.joint_states_publisher = rospy.Publisher('gripper_states', JointState, queue_size=10)

		self.updater = diagnostic_updater.Updater()
		self.updater.setHardwareID("Weiss Robotics Gripper IEG 55-020 V1.02 SN 000160")
